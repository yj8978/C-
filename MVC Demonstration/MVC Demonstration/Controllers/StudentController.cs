...
namespace MVC_Demonstration.Controllers
{
    public class StudentController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                new Student { Id= 1, Name="Yogesh Jirel", Age=21, Address="Kathmandu", Phone="9818888888", Course="CSIT" },
                new Student { Id= 2, Name="Patrick Bateman", Age=20, Address="Kathmandu", Phone="9812345677", Course="CSIT" },
                new Student { Id= 3, Name="Hammock Christ", Age=23, Address="Kathmandu", Phone="1234567890", Course="CSIT" }
            };
